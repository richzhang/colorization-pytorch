...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lambda_GAN', type=float, default=0., help='weight for GAN loss')
        self.parser.add_argument('--lambda_A', type=float, default=10., help='weight for cycle loss (A -> B -> A)')
        self.parser.add_argument('--lambda_B', type=float, default=10., help='weight for cycle loss (B -> A -> B)')
